...
\hline
\textbf{Yêu cầu đặc biệt} & Hỗ trợ tải lên tối đa 5 tệp bằng chứng (ảnh/video). \\
\hline
\textbf{Trạng thái hệ thống ngay khi bắt đầu thực hiện} & Người dùng đã đăng nhập.\\
\hline
\textbf{Trạng thái hệ thống sau khi bắt đầu thực hiện} & Một yêu cầu trả hàng được tạo ở trạng thái "RETURN_DRAFT". \\
\hline
