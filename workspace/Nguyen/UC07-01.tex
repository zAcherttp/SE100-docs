...
\begin{enumerate}
    \vspace{-18pt}
    \item Người dùng chọn chức năng “Tạo phiên kiểm kê”.
    \item Nhập thông tin: khu vực, thời gian, người thực hiện.
    \item Hệ thống tạo phiên kiểm kê và chuyển sang trạng thái “Đang kiểm kê”.
\end{enumerate} \\
\hline
...
\hline
\textbf{Điểm mở rộng} & Bao gồm UC07-02 Thực hiện kiểm kê thực tế. \\
\hline
\end{tabular}
